  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative bg-gradient-to-br from-[hsl(var(--robot-navy))] to-[hsl(var(--primary))] text-[hsl(var(--robot-light))] overflow-visible">
        <div className="max-w-7xl mx-auto px-4 py-18 md:py-28 overflow-visible">
          <div className="flex items-center gap-10">
            <div className="max-w-2xl flex-1">
              <h1 className="text-4xl md:text-[3.5rem] font-extrabold leading-tight mb-5">
                Robotics, Made Practical.
              </h1>
              <p className="text-lg md:text-xl opacity-90 mb-9 leading-relaxed">
            ...
            <div className="hidden md:block w-[400px] h-[400px] flex-shrink-0 overflow-visible">
              <FloatingRobot />
            </div>
          </div>
        </div>
