  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "float-orb-reverse": "float-orb-reverse 7s ease-in-out infinite",
      },
      boxShadow: {
        soft: "0 2px 20px -4px hsl(var(--primary) / 0.08)",
        "soft-lg": "0 8px 30px -8px hsl(var(--primary) / 0.12)",
        "card-hover": "0 12px 40px -12px hsl(var(--primary) / 0.15)",
      },
    },
  },
